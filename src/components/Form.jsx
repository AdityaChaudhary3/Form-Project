...
export default function Form() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className=" w-full  p-2 sm:p-3 md:p-4 flex flex-col justify-center items-center"> 
      ...
      <label className=" md:w-1/2 w-full mb-6 md:mb-2">1. What is the Name of Block</label>
      ...
      <label className=" md:w-1/2 w-full mb-6 md:mb-2">2.What is Name of Gram Panchayat.</label>
      ...
      <div className=" w-full rounded-lg h-auto p-3 mb-4  flex flex-col md:flex-row items-center justify-around">
      <label className=" md:w-1/2 w-full mb-6 md:mb-2">3.What is the Name of the head of the Familly ?</label>
      ...
      <div className=" w-full rounded-lg h-auto p-3 mb-4  flex flex-col md:flex-row items-center justify-around">
      <label className=" md:w-1/2 w-full mb-6 md:mb-2">4.What is the Familly ID ? (Ration Card ID)</label>
      ...
      <div className=" w-full rounded-lg h-auto p-3 mb-4  flex flex-col md:flex-row items-center justify-around">
      <label className=" md:w-1/2 w-full mb-6 md:mb-2">6.How much is the Familly Income ? (In Lakhs)</label>
      <input className="w-full md:w-1/2 p-3"  type="text" placeholder="How much is the Familly Income ? (In Lakhs)" {...register("6.How much is the Familly Income ? (In Lakhs)", {required: true})} />
      </div>
      <div className=" w-full rounded-lg h-auto p-3 mb-4  flex flex-col md:flex-row items-center justify-around">
      <label className=" md:w-1/2 w-full mb-6 md:mb-2">7.What is the Address of the Familly ?"</label>
      ...
      <div className=" w-full rounded-lg h-auto p-3 mb-4  flex flex-col md:flex-row items-center justify-around">
      <label className=" md:w-1/2 w-full mb-6 md:mb-2">8.What is the category of the Familly ? (SC/ST/OBC/General)"</label>
      ...
      <div className=" w-full rounded-lg h-auto p-3 mb-4  flex flex-col md:flex-row items-center justify-around">
      <label className=" md:w-1/2 w-full mb-6 md:mb-2">9.How much land the Familly Owns ? (In Bigha)"</label>
      <input className="w-full md:w-1/2 p-3"  type="number" placeholder="How much land the Familly Owns ? (In Bigha)" {...register("9.How much land the Familly Owns ? (In Bigha)", {required: true})} />
      </div>
      <div className=" w-full rounded-lg h-auto p-3 mb-4  flex flex-col md:flex-row items-center justify-around">
      <label className=" md:w-1/2 w-full mb-6 md:mb-2">10.Type of House  Ownership ?</label>
      ...
      <div className=" w-full rounded-lg h-auto p-3 mb-4  flex flex-col md:flex-row items-center justify-around">
      <label className=" md:w-1/2 w-full mb-6 md:mb-2">11.Religion of the family?</label>
      ...
      <div className=" w-full rounded-lg h-auto p-3 mb-4  flex flex-col md:flex-row items-center justify-around">
      <label className=" md:w-1/2 w-full mb-6 md:mb-2">12.Do the Familly have MGNREGA Job Card ?</label>
      ...
      <div className=" w-full rounded-lg h-auto p-3 mb-4  flex flex-col md:flex-row items-center justify-around">
      <label className=" md:w-1/2 w-full mb-6 md:mb-2">13.Type of house</label>
      ...
      <div className=" w-full rounded-lg h-auto p-3 mb-4  flex flex-col md:flex-row items-center justify-around">
      <label className=" md:w-1/2 w-full mb-6 md:mb-2">14.Do the Familly have electricity connection </label>
      ...
      <div className=" w-full rounded-lg h-auto p-3 mb-4  flex flex-col md:flex-row items-center justify-around">
      <label className=" md:w-1/2 w-full mb-6 md:mb-2">15. Do the Familly have Gas Connection ?</label>
      ...
      <div className=" w-full rounded-lg h-auto p-3 mb-4  flex flex-col md:flex-row items-center justify-around">
      <label className=" md:w-1/2 w-full mb-6 md:mb-2">16.Do the Familly benefited through Ujjwala Scheme ? ?</label>
      ...
      <div className=" w-full rounded-lg h-auto p-3 mb-4  flex flex-col md:flex-row items-center justify-around">
      <label className=" md:w-1/2 w-full mb-6 md:mb-2">17.Do the Familly have Individual toilets ?</label>
      ...
      <div className=" w-full rounded-lg h-auto p-3 mb-4  flex flex-col md:flex-row items-center justify-around">
      <label className=" md:w-1/2 w-full mb-6 md:mb-2">18.Whether received Awas under PMAY/CMAY?</label>
      ...
      <div className=" w-full rounded-lg h-auto p-3 mb-4  flex flex-col md:flex-row items-center justify-around">
      <label className=" md:w-1/2 w-full mb-6 md:mb-2">19.Familly have taken loan under any scheme ?</label>
      ...
      <div className=" w-full rounded-lg h-auto p-3 mb-4  flex flex-col md:flex-row items-center justify-around">
      <label className=" md:w-1/2 w-full mb-6 md:mb-2">20.Does the Familly covered under Fasal Bima Yojana ?</label>
      ...
      <div className=" w-full rounded-lg h-auto p-3 mb-4  flex flex-col md:flex-row items-center justify-around">
      <label className=" md:w-1/2 w-full mb-6 md:mb-2">21.Familly got connection under Har Ghar Jal Jal Jeevan Mission ?</label>
      ...
      <div className=" w-full rounded-lg h-auto p-3 mb-4  flex flex-col md:flex-row items-center justify-around">
      <label className=" md:w-1/2 w-full mb-6 md:mb-2">22.Whether Familly got benefitted from CM Vivah Yojana ?</label>
      ...
      <div className=" w-full rounded-lg h-auto p-3 mb-4  flex flex-col md:flex-row items-center justify-around">
      <label className=" md:w-1/2 w-full mb-6 md:mb-2">23. Familly got connection under Har Ghar Jal ?</label>
      ...
      <div className=" w-full rounded-lg h-auto p-3 mb-4  flex flex-col md:flex-row items-center justify-around">
      <label className=" md:w-1/2 w-full mb-6 md:mb-2">24. Main Occupation of the Familly ?</label>
      ...
      <div className=" w-full rounded-lg h-auto p-3 mb-4  flex flex-col md:flex-row items-center justify-around">
      <label className=" md:w-1/2 w-full mb-6 md:mb-2">25.How many members in the Familly ?</label>
