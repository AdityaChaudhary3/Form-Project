  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="p-4 flex flex-col justify-center items-center">
      ...
      <div className="mb-4 w-full h-auto p-3 rounded-lg flex flex-col md:flex-row items-center justify-around">
        ...
        <input className="w-full md:w-1/2 h-2/3 p-3" type="number" placeholder="2. Family Members Age?" {...register("2.Family Members Age", { min: 1 })} />
      </div>

      <div className="mb-4 w-full h-auto p-3 rounded-lg flex flex-col md:flex-row items-center justify-around">
        <label className="w-full md:w-1/2 mb-6 md:mb-0">3. Mobile number</label>
        <input className="w-full md:w-1/2 h-2/3 p-3" type="number" placeholder="3. Mobile number" {...register("3.Mobile number", { required: true, minLength: 10, maxLength: 10 })} />
      </div>
      ...
      <div className="mb-4 w-full h-auto p-3 rounded-lg flex flex-col md:flex-row items-center justify-around">
        ...
        <input className="w-full md:w-1/2 h-2/3 p-3" type="text" placeholder="5. Family Members Employment details" {...register("5.Family Members Employment details", {})} />
      </div>
      ...
      <div className="mb-4 w-full h-auto p-3 rounded-lg flex flex-col md:flex-row items-center justify-around">
        ...
        <input className="w-full md:w-1/2 h-2/3 p-3" type="number" placeholder="6. Number of children studying in primary and upper primary school in family" {...register("6.Number of children studying in primary and upper primary school in family", {})} />
      </div>

      <div className="mb-4 w-full h-auto p-3 rounded-lg flex flex-col md:flex-row items-center justify-around">
        <label className="w-full md:w-1/2 mb-6 md:mb-0">7. Number of children studying in aganbadi</label>
        <input className="w-full md:w-1/2 h-2/3 p-3" type="number" placeholder="7. Number of children studying in aganbadi" {...register("7.Number of children studying in aganbadi", {})} />
      </div>
